...
List every task currently registered in Gymnasium and available environments with `C:\Users\[YOUR USER]\[YOUR PROJECT NAME]>python scripts/list_envs.py` : `python scripts/list_envs.py`. -> you should see your project and tasks listed
